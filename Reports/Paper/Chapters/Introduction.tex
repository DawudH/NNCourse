...
The research presented in this paper dives into how to best colorize an image using a Convolutional Neural Network (CNN). This 

The main question of the research described in this paper is how to colorize an image. After closer inspection 
