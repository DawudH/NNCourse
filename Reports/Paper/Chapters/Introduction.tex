...
\IEEEPARstart{I}{n} this paper several approaches to using a deep neural network to colorize grayscale images are compared. Specifically, given a grayscale image, the neural network can generate all the data needed to present a color version of the same image, without input of the user. 
