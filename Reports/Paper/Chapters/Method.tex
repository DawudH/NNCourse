...
The combination of these three layers result in a certain color.
...
The a and b layers are the color components. CIELab distinguishes itself from YCbCr due to the fact that this colorspace can, in theory, display all 
